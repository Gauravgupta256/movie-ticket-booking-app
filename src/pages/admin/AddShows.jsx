...
const AddShows = () => {
  ...
  <div className='overflow-x-auto pb-4'>
    <div className='group flex flex-wrap gap-4 mt-4 w-max'>
      ...
      {selectedMovie === movie.id && (
        <div className='absolute top-2 right-2 flex items-center justify-center bg-primary h-6 w-6 rouned'>
  ...
  <div className='mt-6'>
    ...
    <div className='inline-flex gap-5 border border-gray-600 p-1 pl-3 rouded-lg'>
      ...
      <button onClick={handleDateTimeAdd} className='bg-primary/80 text-white px-3 py-2 text-sm rouded-lg hover:bg-primary cursor-pointer'>
        Add Time
      </button>
    </div>
