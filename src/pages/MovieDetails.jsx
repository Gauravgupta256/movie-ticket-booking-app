        ...
        <div className='relative flex flex-col gap-3'>
          ...
          <p>
            ...
            <div className='flex items-center flex-wrap gap-4 mt-4'>
              ...
              <a className='px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-md font-medium cursor-pointer active:scale-95' href="#dateSelect">Buy ticket</a>
<button
