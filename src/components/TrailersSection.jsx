        ...
        <p className='text-gray-300 font-medium text-lg max-w-[960px'>
            ...
            <div className='group grid grid-cols-4 gap-4 md:gap-8 mt-8 max-w-3xl mx-auto'>
                {dummyTrailers.map((trailer)=>(
                    <div key={trailer.image} className='relative group-hover:not-hover:opacity-50 hover:-translate-y-1 duration-300 transition max-md:h-60 md:mx-h-60 cursor-pointer' onClick={()=>setCurrentTrailer(trailer)}>
